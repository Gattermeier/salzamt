...
- Do not touch `CNAME` or the six original PNGs at the repo root.
...
salzamt.png, salzamt_circle.png, salzamt_poster.png, salzamt_stamp.png,
Salzbug_Postkarte_A6.png, Wappen-Postkarte-A6.png                          (untouched originals)
```
